...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 1/10: Platform Core: % ---', '01_platform_core.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 1/10: Platform Core complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 2/10: Platform API
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 2/10: Platform API: % ---', '02_platform_api.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 2/10: Platform API complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 3/10: DocSlot Product
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 3/10: DocSlot Product: % ---', '03_docslot.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 3/10: DocSlot Product complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 4/10: Security Hardening
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 4/10: Security Hardening: % ---', '05_security_hardening.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 4/10: Security Hardening complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 5/10: AI Services
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 5/10: AI Services: % ---', '06_ai_services.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 5/10: AI Services complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 6/10: Commission & Broker
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 6/10: Commission & Broker: % ---', '07_commission_broker.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 6/10: Commission & Broker complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 7/10: RBAC Enhancements
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 7/10: RBAC Enhancements: % ---', '08_rbac_navigation.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 7/10: RBAC Enhancements complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 8/10: Chat Identity & Discount
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 8/10: Chat Identity & Discount: % ---', '09_chat_identity.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 8/10: Chat Identity & Discount complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 9/10: Future Products (Optional)
...
DO $section$
BEGIN
    RAISE NOTICE '--- PART 9/10: Future Products (Optional): % ---', '04_future_products.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 9/10: Future Products (Optional) complete ---';
    RAISE NOTICE '';
END $section_end$;


-- ============================================================================
-- PART 10/10: Roles & Grants
-- Least-privilege docslot_app role + grants (RLS-enforced, audit append-only) — runs LAST
-- Source: database/10_roles_grants.sql
-- ============================================================================

DO $section$
BEGIN
    RAISE NOTICE '--- PART 10/10: Roles & Grants: % ---', '10_roles_grants.sql';
END $section$;
...
DO $section_end$
BEGIN
    RAISE NOTICE '--- PART 10/10: Roles & Grants complete ---';
    RAISE NOTICE '';
END $section_end$;
