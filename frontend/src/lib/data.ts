...
export const BOOKINGS: Booking[] = [
  { id: 'B-2841', token: 12, patient: 'Riya Kapoor', phone: '+91 98203 14572', age: 31, gender: 'F', doctorId: 'd1', doctorName: 'Dr. Anjali Sharma', dept: 'Cardiology', date: 'Today', time: '11:30', duration: 15, status: 'pending', source: 'whatsapp', note: 'Chest pain since morning. भूख नहीं लग रही.', createdAgo: '2 min ago', lang: 'hi' },
  { id: 'B-2840', token: 11, patient: 'Aman Shah', phone: '+91 99205 88812', age: 42, gender: 'M', doctorId: 'd2', doctorName: 'Dr. Rohan Iyer', dept: 'Cardiology', date: 'Today', time: '12:00', duration: 15, status: 'pending', source: 'whatsapp', note: 'Follow-up — ECG report attached', createdAgo: '5 min ago', lang: 'en' },
  { id: 'B-2839', token: 14, patient: 'Sneha Reddy', phone: '+91 90415 22034', age: 28, gender: 'F', doctorId: 'd3', doctorName: 'Dr. Priya Nair', dept: 'Gynaecology', date: 'Today', time: '10:45', duration: 20, status: 'pending', source: 'whatsapp', note: 'First visit — antenatal', createdAgo: '12 min ago', lang: 'en' },
  { id: 'B-2838', token: 7, patient: 'Karan Mehta', phone: '+91 98701 56432', age: 8, gender: 'M', doctorId: 'd5', doctorName: 'Dr. Meera Krishnan', dept: 'Paediatrics', date: 'Today', time: '10:30', duration: 15, status: 'confirmed', source: 'whatsapp', note: 'Fever 102°F, cough', createdAgo: '32 min ago', lang: 'en' },
  { id: 'B-2837', token: 18, patient: 'Pooja Singh', phone: '+91 99113 47720', age: 56, gender: 'F', doctorId: 'd4', doctorName: 'Dr. Vikram Bose', dept: 'Orthopedics', date: 'Today', time: '13:15', duration: 20, status: 'confirmed', source: 'walk_in', note: 'Knee pain — review', createdAgo: '1 hr ago', lang: 'en' },
  { id: 'B-2836', token: 6, patient: 'Aditya Pillai', phone: '+91 90008 11420', age: 34, gender: 'M', doctorId: 'd6', doctorName: 'Dr. Saurabh Gupta', dept: 'Dermatology', date: 'Today', time: '14:00', duration: 15, status: 'confirmed', source: 'whatsapp', note: 'Rash on forearms', createdAgo: '2 hr ago', lang: 'en' },
  { id: 'B-2835', token: 4, patient: 'Divya Joshi', phone: '+91 87012 90034', age: 39, gender: 'F', doctorId: 'd8', doctorName: 'Dr. Lakshmi Rao', dept: 'General Medicine', date: 'Today', time: '10:15', duration: 15, status: 'completed', source: 'whatsapp', note: 'Routine checkup', createdAgo: '3 hr ago', lang: 'en' },
  { id: 'B-2834', token: 3, patient: 'Nikhil Bhatt', phone: '+91 98671 22311', age: 50, gender: 'M', doctorId: 'd8', doctorName: 'Dr. Lakshmi Rao', dept: 'General Medicine', date: 'Today', time: '10:00', duration: 15, status: 'completed', source: 'phone_call', note: 'BP review', createdAgo: '3 hr ago', lang: 'en' },
  { id: 'B-2833', token: 2, patient: 'Tanvi Iyer', phone: '+91 90120 56781', age: 26, gender: 'F', doctorId: 'd3', doctorName: 'Dr. Priya Nair', dept: 'Gynaecology', date: 'Today', time: '09:45', duration: 20, status: 'no_show', source: 'whatsapp', note: '—', createdAgo: '4 hr ago', lang: 'en' },
  { id: 'B-2832', token: 9, patient: 'Harsh Patel', phone: '+91 99882 03114', age: 19, gender: 'M', doctorId: 'd7', doctorName: 'Dr. Faisal Khan', dept: 'ENT', date: 'Today', time: '15:30', duration: 15, status: 'pending', source: 'whatsapp', note: 'Throat infection — kal se', createdAgo: '18 min ago', lang: 'hi' },
  { id: 'B-2831', token: 1, patient: 'Meera Joshi', phone: '+91 87760 12039', age: 64, gender: 'F', doctorId: 'd1', doctorName: 'Dr. Anjali Sharma', dept: 'Cardiology', date: 'Today', time: '09:30', duration: 15, status: 'completed', source: 'whatsapp', note: 'Hypertension review', createdAgo: '5 hr ago', lang: 'en' },
];
