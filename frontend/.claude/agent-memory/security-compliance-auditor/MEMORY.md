...
- [Frontend Settings screen (Phase 1)](frontend-settings-screen.md) — WhatsApp token never on wire, PATCH whitelisted to 2 sections, can()-gated forbidden card, locale-only lang switcher
